...
set_property IOSTANDARD LVCMOS33 [get_ports {multi_sel[0]}]
set_property PACKAGE_PIN R11 [get_ports {multi_sel[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {multi_sel[1]}]
set_property PACKAGE_PIN T12 [get_ports {multi_sel[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {multi_sel[2]}]
set_property PACKAGE_PIN T13 [get_ports {multi_sel[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {multi_sel[3]}]
