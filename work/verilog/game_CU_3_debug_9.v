...
module game_CU_3_debug_9 (
  ...
  localparam CHECK_MSB_RIGHT_HALF_game_fsm = 6'd17;
  localparam CMPEQ_RIGHT_game_fsm = 6'd18;
  localparam BRANCH_CMPEQ_RIGHT_game_fsm = 6'd19;
  localparam PLUS1_TO_LEFT_HALF_game_fsm = 6'd20;
  localparam CHECK_MSB_LEFT_HALF_game_fsm = 6'd21;
  localparam CMPEQ_LEFT_game_fsm = 6'd22;
  localparam BRANCH_CMPEQ_LEFT_game_fsm = 6'd23;
  localparam PLUS1_TO_RIGHT_HALF_game_fsm = 6'd24;
  localparam CHECK_P2_LOSE_game_fsm = 6'd25;
  localparam BRANCH_P2_LOSE_OR_CARRYON_game_fsm = 6'd26;
  localparam P2_LED_LIGHT_UP_game_fsm = 6'd27;
  localparam P2_SCORE_INCREASE_BY_1_game_fsm = 6'd28;
  localparam CHECK_P1_LOSE_game_fsm = 6'd29;
  localparam BRANCH_P1_LOSE_OR_CARRYON_game_fsm = 6'd30;
  localparam P1_LED_LIGHT_UP_game_fsm = 6'd31;
  localparam P1_SCORE_INCREASE_BY_1_game_fsm = 6'd32;
  localparam CHECK_ANY_LED_FIRST_HALF_NOT_LIT_game_fsm = 6'd33;
  localparam CHECK_ANY_LED_SECOND_HALF_NOT_LIT_game_fsm = 6'd34;
  localparam CMPEQ_FIRST_HALF_game_fsm = 6'd35;
  localparam BRANCH_FIRST_HALF_game_fsm = 6'd36;
  localparam CMPEQ_SECOND_HALF_game_fsm = 6'd37;
  localparam BRANCH_SECOND_HALF_game_fsm = 6'd38;
  localparam CHECK_COUNT_MORETHAN_0_game_fsm = 6'd39;
  localparam CHECK_TIMER_game_fsm = 6'd40;
  localparam BRANCH_TIMER_game_fsm = 6'd41;
  localparam COUNT_MINUS_1_game_fsm = 6'd42;
  localparam CHECK_DRAW_game_fsm = 6'd43;
  localparam BRANCH_DRAW_game_fsm = 6'd44;
  localparam DRAW_game_fsm = 6'd45;
  localparam CHECK_WINNER_game_fsm = 6'd46;
  localparam BRANCH_WINNER_game_fsm = 6'd47;
  localparam P1_WINS_game_fsm = 6'd48;
  localparam P2_LOSES_game_fsm = 6'd49;
  localparam LIGHT_LOWER_LEFT_LED_game_fsm = 6'd50;
  localparam LIGHT_UPPER_RIGHT_LED_game_fsm = 6'd51;
  localparam P2_WINS_game_fsm = 6'd52;
  localparam P1_LOSES_game_fsm = 6'd53;
  localparam LIGHT_UPPER_LEFT_LED_game_fsm = 6'd54;
  localparam LIGHT_LOWER_RIGHT_LED_game_fsm = 6'd55;
  localparam GAMEOVER_game_fsm = 6'd56;
    ...
    if (rst) begin
      ...
      case (M_game_fsm_q)
        ...
        INCREASE_SPEED_game_fsm: begin
          ...
          regfile_write_address = 4'h5;
          wdsel = 4'h0;
          M_game_fsm_d = COUNTDOWN_SUSPENSE_game_fsm;
        end
        ...
        COUNTDOWN_SUSPENSE_game_fsm: begin
        ...
        BRANCH_FIRST_HALF_game_fsm: begin
          ...
          regfile_read_address_b = 4'h8;
          if (rb_data == 1'h1) begin
            M_game_fsm_d = CMPEQ_SECOND_HALF_game_fsm;
          end else begin
            M_game_fsm_d = IDLE_game_fsm;
          end
        end
        CMPEQ_SECOND_HALF_game_fsm: begin
          alufn = 7'h33;
          asel = 2'h2;
          bsel = 2'h0;
          we_regfile = 1'h1;
