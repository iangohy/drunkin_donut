...
module au_debugger_6 (
  ...
  localparam DATA_WIDTH = 8'h9a;
  localparam CAPTURE_DEPTH = 9'h100;
  localparam NONCE = 30'h30108248;
  ...
  reg [153:0] M_data_old_d, M_data_old_q = 1'h0;
  reg [615:0] M_trigger_data_d, M_trigger_data_q = 1'h0;
  ...
  reg [153:0] M_rdata_d, M_rdata_q = 1'h0;
  ...
  wire [154-1:0] M_ram_read_data;
  reg [8-1:0] M_ram_waddr;
  reg [154-1:0] M_ram_write_data;
  reg [1-1:0] M_ram_write_en;
  reg [8-1:0] M_ram_raddr;
  simple_dual_ram_15 #(.SIZE(8'h9a), .DEPTH(9'h100)) ram (
  ...
  always @* begin
    ...
    if (M_info_scan_SEL) begin
      if (M_info_scan_CAPTURE) begin
        M_status_d = 104'h03000001000000009a30108248;
      end else begin
    ...
    if (!M_config_fifo_empty) begin
      M_trigger_data_d = {M_config_fifo_dout, M_trigger_data_q[1+614-:615]};
    end
    ...
    case (M_state_q)
      ...
      ARMED_state: begin
        triggered = 1'h1;
        for (i = 1'h0; i < 8'h9a; i = i + 1) begin
    ...
    if (M_data_scan_SEL) begin
      if (M_data_scan_CAPTURE) begin
        ...
        if (M_data_scan_SHIFT) begin
          M_rdata_d = {1'h0, M_rdata_q[1+152-:153]};
          M_offset_d = M_offset_q + 1'h1;
          if (M_offset_q == 9'h099) begin
            M_offset_d = 1'h0;
            M_rdata_d = M_ram_read_data;
            M_raddr_d = M_raddr_q + 1'h1;
          end
